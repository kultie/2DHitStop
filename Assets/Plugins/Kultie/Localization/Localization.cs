...
namespace Kultie
{
    ...
    {
        private Dictionary<string, Dictionary<string, string>> localizationMap =
        ...
        public static string Get(string key, bool format = true)
        {
            ...
            try
            {
                ...
                {
                    return format
                        ? Regex.Unescape(Instance.localizationMap[Instance.languages[Instance.currentLanguage]][key])
